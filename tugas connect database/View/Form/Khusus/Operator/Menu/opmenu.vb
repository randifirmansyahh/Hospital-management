Public Class admenu
    ...
    Private Sub showkomentar()
        ...
        Catch ex As Exception
            MsgBox("Tidak ada komentar untuk saat ini", MsgBoxStyle.Information)
        End Try
    End Sub
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        ElseIf check.checkcount("pasien") = "0" Then
            MsgBox("Anda harus menambahkan Pasien terlebih dahulu untuk mengakses pembayaran", MsgBoxStyle.Critical)
        ElseIf check.checkcount("dokter") = "0" Then
            MsgBox("Anda harus menambahkan Dokter terlebih dahulu untuk mengakses Pasien", MsgBoxStyle.Critical)
        ElseIf check.checkcountfromwhatwhere("petugas", "Divisi", "Kasir") = "0" Then
            MsgBox("Anda harus menambahkan petugas Divisi Kasir terlebih dahulu untuk mengakses Pasien", MsgBoxStyle.Critical)
        ElseIf check.checkcountfromwhatwhere("petugas", "Divisi", "HRD") = "0" Then
            MsgBox("Anda harus menambahkan petugas Divisi HRD terlebih dahulu untuk mengakses Pasien", MsgBoxStyle.Critical)
        Else
            Me.Hide()
            opdetail.Show()
        End If
